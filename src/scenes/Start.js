export default class Start extends Phaser.Scene {
    ...
    create() {
        ...
        const respondentIncomeThird =
            this.normalizeIncomeThird(
                urlParams.get(
                    'respondentIncomeThird'
                ) ||
                urlParams.get(
                    'respondentIncomeThirdValue'
                ) ||
                ''
            );
        ...
        this.requestedSelfInterestCondition = (
            ...
            urlParams.get(
                'selfInterestConditionValue'
            ) ||
            ''
        ).trim().toLowerCase();

        this.qualtricsParentOrigin =
            this.normalizeParentOrigin(
                urlParams.get(
                    'parentOrigin'
                ) ||
                ''
        ...
        this.gameData = {
            ...
            respondentRoleRevealed:
                false,

            selfInterestCondition:
                null,

            selfInterestConditionIssue:
                null,
            ...
            selfInterestAllocationSurvivors:
                null,

            selfInterestAllocationGini:
                null,

            selfInterestAllocationClassification:
                null,

            selfInterestAllocationTotalMoved:
                null,

            selfInterestAllocationMethod:
                null,

            selfInterestOwnStartingFood:
                null,

            selfInterestOwnFinalFood:
                null,
        ...
        this.instructionScreens = [
            ...
            'Today, Person A collected 6 pieces of food, Person B collected 4 pieces of food, and Person C collected 2 pieces of food.',
    ...
    buildSurplusOnlyPartialAllocation() {
         ...
         * remaining pieces using the largest-remainder
         * method.
         */
    ...
    assignSelfInterestCondition() {
        ...
        if (storageKey) {
            try {
                ...
                // Continue with a new assignment.
            }
        }
    ...
    getCountingBlanketFoodPosition(
        index
    ) {
        const positions = [
            [-150, -25],
    ...
    showDistributivePrincipleQuestion() {
        ...
        const answers =
            Phaser.Utils.Array.Shuffle([
                ...
                'Making sure the person who collects the most least has enough food to survive.'
            ]);
    ...
    showPersonDInstructionScreen() {
        ...
        this.addQuestionObject(
            this.add.text(
                640,
                165,
                'A new person (Person D) wanders into the groupâ€™s location and begs for food. The new person is peaceful and not threatening.',
                {
                    fontSize: '27px',
                    color: '#000000',
                    align: 'center',
    ...
    showRespondentRoleScreen ()
{
    ...
    this.addQuestionObject(
        this.add.text(
            640,
            110,
            `Imagine that you are ${respondentRole}, who is outlined in green.\nYou have ${respondentFood} pieces of food.`,
            {
                fontSize: '32px',
                color: '#000000',
                align: 'center',
    ...
    classifySelfInterestAllocation(
        ...
        if (
            ...
            return (
                'acquisition_priority_maximum_survival'
            );
        }
    ...
    showFinalGameScreen() {
         ...
         * Phaser does not enforce a minimum time.
         */
        this.gameData.saveStatus =
            'attempted';
