export default class Start extends Phaser.Scene {
    ...
    create() {
        ...
        this.gameData = {
            ...
            gameVersion: 'insufficiency_english_gini_preferences_v2',
    ...
    drawTree() {
        const trunkColor = 7029798;
        const branchColor = 5911839;
        const branches = [
            {
                x: 1038,
                y: 330,
        ...
        branches.forEach(branch => {
            const branchShape = this.add.rectangle(branch.x, branch.y, branch.width, branch.height, branchColor);
            branchShape.setAngle(branch.angle);
            this.addGameObject(branchShape);
        });
        ...
        fruitPositions.forEach(position => {
            const stem = this.add.line(position.x, position.y - 15, 0, 0, 0, 13, branchColor);
            stem.setLineWidth(2);
            stem.setDepth(7);
            this.addGameObject(stem);
            const fruit = this.add.circle(position.x, position.y, 6, 11674146);
